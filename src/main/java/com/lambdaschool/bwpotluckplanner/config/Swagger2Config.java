package com.lambdaschool.bwpotluckplanner.config;
...
public class Swagger2Config
{
    ...
    public Docket api()
    {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .apis(RequestHandlerSelectors
                        .basePackage("com.lambdaschool.bwpotluckplanner"))
    ...
    private ApiInfo apiEndPointsInfo()
    {
        return new ApiInfoBuilder().title("User Model Example")
                ...
                .license("MIT")
                .licenseUrl("https://github.com/potluckplanner711/backend/blob/master/LICENSE")
                .version("1.0.0")
                .build();
    }
}